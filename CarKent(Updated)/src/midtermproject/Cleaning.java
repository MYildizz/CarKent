...
public class Cleaning  extends MotherMain {
    ...
    public Cleaning(String ID, String name, String surname, String identity, String profession, String gender) {
        super(ID);
        person = new Personality(name, surname, identity, profession, gender);
        total_Cleaning++;
    ...
    public static double DecidePriceAccordingtoCarType(String car, String profession , boolean condition, boolean interior_wash , boolean exterior_wash, boolean auto_Hairdresser, boolean wax_polish)
    {
        ...
        {
            if (interior_wash == true && exterior_wash == false){
                total_water_and_Foam--;
                consume_WaF++;
                sales += 50.0; 
            }
            
            else if (interior_wash == false && exterior_wash == true){
                total_water_and_Foam--;
                consume_WaF++;
                sales += 60.0;
            }
            
            else if(interior_wash == true && exterior_wash == true){
            ...
            if( ( profession.equalsIgnoreCase("Doctor") || profession.equalsIgnoreCase("Police") || profession.equalsIgnoreCase("Student") || profession.equalsIgnoreCase("Soldier") ) && condition == true  )
                sales -= sales * 0.12;
            
            if(( profession.equalsIgnoreCase("Doctor") || profession.equalsIgnoreCase("Police") || profession.equalsIgnoreCase("Student") || profession.equalsIgnoreCase("Soldier") ) && condition == false)
                sales -= sales * 0.08;
