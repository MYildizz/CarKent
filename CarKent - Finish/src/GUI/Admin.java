...
public class Admin extends javax.swing.JFrame {
    ...
    public void finance()
    {
        String tl=""+shorted.format(MotherMain.getTotalMoney())+" TL";
        jTextField1.setText(tl);
        String Dollar=""+shorted.format(MotherMain.getTotalDollarMoney()) +" Dollar";
        jTextField2.setText(Dollar);
        String Euro=""+shorted.format(MotherMain.getTotalEuroMoney()) + " Euro ";
        ...
        FECharge.setText(" "+ElectricCar.getEChargebattery());
         ...
         tax.setText(""+shorted.format(MotherMain.Tax)+" TL");
         electric.setText(""+shorted.format(MotherMain.Electric)+" TL");
    ...
    public void AddtoTableParking(){
        ...
        AllTable = (DefaultTableModel)REPAIR_CLEANING_PARK.AllTable.getModel();
        ...
        for (int i = 0; i < InfoClass.infoCustomer.size(); i++) {
            if(InfoClass.infoCustomer.get(i) instanceof Jip){
                ...
                modelPC.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), j.getPerson().name , j.getPerson().surname, j.getPerson().Gender , j.getPerson().Profession , j.getPerson().IdentityNo, 
                    j.getCarParkingArea(),j.getEnteringtime(), j.getExitingTime(), j.CurrentMoney()});
                ...
                AllTable.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), j.getPerson().name , j.getPerson().surname, j.getPerson().Gender , j.getPerson().Profession , j.getPerson().IdentityNo, 
                    j.getEnteringtime(), j.getExitingTime(), "Automobile","- - - - -","- - - - -","- - - - -", j.CurrentMoney()});
                
            }
                
            else if(InfoClass.infoCustomer.get(i) instanceof Lorry){
                Lorry L = (Lorry) InfoClass.infoCustomer.get(i);
                modelPL.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), L.getPerson().name, L.getPerson().surname, L.getPerson().Gender, L.getPerson().Profession,L.getPerson().IdentityNo,
                    L.getCarParkingArea(),L.getEnteringtime(), L.getExitingTime(),L.CurrentMoney()});
                
                modelPA.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), L.getPerson().name, L.getPerson().surname, L.getPerson().Gender, L.getPerson().Profession,L.getPerson().IdentityNo,"Lorry",
                    L.getCarParkingArea(),L.getEnteringtime(), L.getExitingTime(),L.CurrentMoney()});
                
                AllTable.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), L.getPerson().name , L.getPerson().surname, L.getPerson().Gender , L.getPerson().Profession , L.getPerson().IdentityNo, 
                    L.getEnteringtime(), L.getExitingTime(), "Lorry","- - - - -","- - - - -","- - - - -", L.CurrentMoney()});
            }
                ...
                modelPM.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), M.getPerson().name, M.getPerson().surname, M.getPerson().Gender, M.getPerson().Profession,M.getPerson().IdentityNo,
                    M.getCarParkingArea(),M.getEnteringtime(), M.getExitingTime(),M.CurrentMoney()});
                
                modelPA.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), M.getPerson().name, M.getPerson().surname, M.getPerson().Gender, M.getPerson().Profession,M.getPerson().IdentityNo,"Two-Wheels",
                    M.getCarParkingArea(),M.getEnteringtime(), M.getExitingTime(),M.CurrentMoney()});
                
                AllTable.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), M.getPerson().name , M.getPerson().surname, M.getPerson().Gender , M.getPerson().Profession , M.getPerson().IdentityNo, 
                    M.getEnteringtime(), M.getExitingTime(), "MotorCycle","- - - - -","- - - - -","- - - - -", M.CurrentMoney()});
            }
        }
    ...
    public void AddtoWash(){
        ...
        for (int i = 0; i < InfoClass.cleaning.size(); i++) {
            ...
            AllTable.addRow(new Object[] {plate, name, surname, gender, ide, prof,"- - - - -","- - - - -", typeVeh,"- - - - -", "- - - - -",typeWash, price});
        }
        
    }

    public void AddtoReapiring(){
        DefaultTableModel repAll = (DefaultTableModel)REPAIR_CLEANING_PARK.RepAllTable.getModel();
        AllTable = (DefaultTableModel)REPAIR_CLEANING_PARK.AllTable.getModel();
        ...
        for (int i = 0; i < InfoClass.infoCustomer.size(); i++) {
            if(InfoClass.infoCustomer.get(i) instanceof DieselCar){
                ...
                repAll.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), d.getPersonalty().name , d.getPersonalty().surname, d.getPersonalty().Gender , d.getPersonalty().Profession , d.getPersonalty().IdentityNo, 
                    d.getModel(), "Diesel", d.gettPrice() });
                
                AllTable.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), d.getPersonalty().name , d.getPersonalty().surname, d.getPersonalty().Gender , d.getPersonalty().IdentityNo, d.getPersonalty().Profession ,  
                    "- - - - -","- - - - -","- - - - -",d.getModel(), "Diesel","- - - - -", d.gettPrice() });
            }
            
            else if(InfoClass.infoCustomer.get(i) instanceof GasolineCar){
                GasolineCar g = (GasolineCar) InfoClass.infoCustomer.get(i);
                repAll.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), g.getPersonalty().name , g.getPersonalty().surname, g.getPersonalty().Gender , g.getPersonalty().Profession , g.getPersonalty().IdentityNo, 
                    g.getModel(), "Gasoline", g.gettPrice() });
                
                AllTable.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), g.getPersonalty().name , g.getPersonalty().surname, g.getPersonalty().Gender , g.getPersonalty().IdentityNo, g.getPersonalty().Profession ,  
                    "- - - - -","- - - - -","- - - - -",g.getModel(), "Gasoline","- - - - -", g.gettPrice()});
            }
            
            else if(InfoClass.infoCustomer.get(i) instanceof ElectricCar){
                ElectricCar e = (ElectricCar) InfoClass.infoCustomer.get(i);
                repAll.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), e.getPersonalty().name , e.getPersonalty().surname, e.getPersonalty().Gender , e.getPersonalty().Profession , e.getPersonalty().IdentityNo, 
                    e.getModel(), "Electric", e.gettPrice() });
                
                AllTable.addRow(new Object[] {InfoClass.infoCustomer.get(i).getID(), e.getPersonalty().name , e.getPersonalty().surname, e.getPersonalty().Gender , e.getPersonalty().IdentityNo, e.getPersonalty().Profession ,  
                    "- - - - -","- - - - -","- - - - -",e.getModel(), "Electric","- - - - -", e.gettPrice() });
            }
    ...
    private void initComponents() {
        ...
        A21L.setBackground(new java.awt.Color(51, 255, 255));
        ...
        A18m.setBackground(new java.awt.Color(0, 255, 255));
        ...
        btDataWash.setBackground(new java.awt.Color(0, 153, 240));
        btDataWash.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        btDataWash.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tfPrice.setFont(new java.awt.Font("Calibri", 0, 30)); // NOI18N
        ...
        jButton12.setBounds(990, 240, 140, 40);

        btInventory.setBackground(new java.awt.Color(0, 0, 0));
        btInventory.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        btInventory.setForeground(new java.awt.Color(255, 0, 0));
        ...
        btInventory.setBounds(1450, 250, 140, 40);
        ...
        name.setFont(new java.awt.Font("Cooper Black", 1, 20)); // NOI18N
        name.setText("NAME :");
        repairing.add(name);
        name.setBounds(960, 310, 150, 30);

        surname.setFont(new java.awt.Font("Cooper Black", 1, 20)); // NOI18N
        surname.setText("SURNAME :");
        repairing.add(surname);
        surname.setBounds(960, 350, 160, 28);

        tc.setFont(new java.awt.Font("Cooper Black", 1, 20)); // NOI18N
        tc.setText("T.C :");
        repairing.add(tc);
        tc.setBounds(960, 390, 70, 30);

        plate.setFont(new java.awt.Font("Cooper Black", 1, 20)); // NOI18N
        plate.setText("PLATE :");
        repairing.add(plate);
        plate.setBounds(960, 430, 110, 30);

        gender.setFont(new java.awt.Font("Cooper Black", 1, 18)); // NOI18N
        gender.setText("GENDER :");
        repairing.add(gender);
        gender.setBounds(960, 470, 110, 30);

        profission.setFont(new java.awt.Font("Cooper Black", 1, 17)); // NOI18N
        profission.setText("PROFESSION :");
        repairing.add(profission);
        profission.setBounds(960, 510, 160, 30);

        model.setFont(new java.awt.Font("Cooper Black", 1, 20)); // NOI18N
        model.setText("MODEL :");
        repairing.add(model);
        model.setBounds(960, 550, 110, 30);

        type.setFont(new java.awt.Font("Cooper Black", 1, 20)); // NOI18N
        type.setText("TYPE :");
        repairing.add(type);
        type.setBounds(960, 590, 110, 30);
        repairing.add(Name);
        Name.setBounds(1100, 310, 110, 30);
        repairing.add(Surname);
        Surname.setBounds(1100, 350, 110, 30);
        repairing.add(Tc);
        Tc.setBounds(1100, 390, 110, 30);
        repairing.add(Plate);
        Plate.setBounds(1100, 430, 110, 30);
        repairing.add(Model);
        Model.setBounds(1100, 550, 110, 30);

        Gender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Male", "Female" }));
        repairing.add(Gender);
        Gender.setBounds(1100, 470, 110, 30);

        Profission.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "OTHER", "POLICE", "STUDENT", "SOLDIER", " " }));
        Profission.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ProfissionActionPerformed(evt);
            }
        });
        repairing.add(Profission);
        Profission.setBounds(1100, 510, 110, 30);

        Type.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Gasoline", "Diesel", "Electric" }));
        repairing.add(Type);
        Type.setBounds(1100, 590, 110, 30);

        btDataRep.setBackground(new java.awt.Color(0, 153, 153));
        btDataRep.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        btDataRep.setText("DATA");
        btDataRep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btDataRepActionPerformed(evt);
            }
        });
        repairing.add(btDataRep);
        btDataRep.setBounds(1310, 140, 110, 30);
        ...
        jButton6.setBounds(1110, 200, 120, 30);
        ...
        add.setFont(new java.awt.Font("Berlin Sans FB", 0, 24)); // NOI18N
        ...
        repairing.add(type1);
        type1.setBounds(960, 630, 200, 20);
        repairing.add(jCheckBox1);
        jCheckBox1.setBounds(1180, 630, 25, 20);
        ...
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/Admin Pictures/SON DEFAULT TEMA_1.jpg"))); // NOI18N
        ...
        miktar.setText("Quantitiy");
        miktar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                miktarMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                miktarMouseExited(evt);
            }
        });
        finance.add(miktar);
        ...
        finance.add(tax);
        tax.setBounds(1310, 320, 150, 40);

        CleaningSalary.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cihat 36.000 TL", "Berkan 1600 TL", "Aytac 300 TL" }));
        ...
        generalI.setBounds(1250, 650, 170, 20);
        ...
        dieselquantity.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        dieselquantity.setText("Quantity");
        dieselquantity.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                dieselquantityMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                dieselquantityMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                dieselquantityMouseExited(evt);
            }
        });
        finance.add(dieselquantity);
        dieselquantity.setBounds(1440, 710, 60, 25);

        electric.setEditable(false);
        electric.setBackground(new java.awt.Color(204, 204, 204));
        electric.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        finance.add(electric);
        electric.setBounds(1310, 480, 150, 40);

        electricquantitiy.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        electricquantitiy.setText("Quantitiy");
        electricquantitiy.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                electricquantitiyMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                electricquantitiyMouseExited(evt);
            }
        });
        finance.add(electricquantitiy);
        electricquantitiy.setBounds(1440, 740, 60, 25);

        Generalquantity.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        Generalquantity.setText("Quantitiy");
        Generalquantity.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                GeneralquantityMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                GeneralquantityMouseExited(evt);
            }
        });
        finance.add(Generalquantity);
        Generalquantity.setBounds(1440, 650, 60, 25);
        ...
        gasolinequantity.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        gasolinequantity.setText("Quantitiy");
        gasolinequantity.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                gasolinequantityMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                gasolinequantityMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                gasolinequantityMouseExited(evt);
            }
        ...
        gasolinequantity.setBounds(1440, 680, 60, 25);
        ...
        finance.add(water);
        water.setBounds(1310, 400, 150, 40);
        ...
        finance.add(jLabel29);
        jLabel29.setBounds(140, 640, 40, 40);
    ...
    private void buttonSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSearchActionPerformed
        if(CheckInfo==true)
        {
                    ...
                    timer.start();
                     ...
                     public void actionPerformed(ActionEvent e) {
                        ...
                        CounterRepair++;
                         ...
                         jProgressBar1.setString("DAMAGE RATE %"+CounterRepair);
                          tespit.setText("DAMAGE IS DETECTING...");
                         ...
                         if(CounterRepair==gasolineCar.getDamage())
                         {
                             ...
                             jProgressBar1.setString("DAMAGE RATE %"+gasolineCar.getDamage());
                            ...
                            JOptionPane.showMessageDialog(Admin.this,"DAMAGE DETECTION WAS MADE");
                         }
                     ...
                     public void actionPerformed(ActionEvent e) {
                        ...
                        CounterRepair++;
                         ...
                         if(CounterRepair==dieselCar.getDamage())
                         {
                             ...
                             jProgressBar1.setString("DAMAGE RATE %"+dieselCar.getDamage());
                              tespit.setText(ArizaTespit);
                     ...
                     public void actionPerformed(ActionEvent e) {
                        ...
                        CounterRepair++;
                         ...
                         if(CounterRepair==electricCar.getDamage())
                         {
                             ...
                             jProgressBar1.setString("DAMAGE RATE %"+electricCar.getDamage());
                              tespit.setText(ArizaTespit);
            ...
            {
                JOptionPane.showMessageDialog(this,"FAILURE DETECTION HAS BEEN MADE !!!!!");
            }
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        profession=(String) Profission.getSelectedItem();
        model=Model.getText();
        RepairType=(String) Type.getSelectedItem();
        ...
        if(CheckInfo==true)
        {
            if(CheckSearch==true)
            {
                if(CheckRepair==false)
                {
                    ...
                    {
                        int n = JOptionPane.showConfirmDialog(null,"Price :"+gasolineCar.gettPrice()+"\n Would You like  Repair ?","Repair",JOptionPane.YES_NO_OPTION);
                        if(n ==JOptionPane.YES_OPTION)
                        {
                              if(gasolineCar.Repair_Car()==true)
                             {
                                ...
                                JOptionPane.showMessageDialog(this,"Your vehicle will be repaired as soon as possible\nHave a Nice Day");
                                finance();    
                        ...
                        {
                            JOptionPane.showMessageDialog(this,"REPAIR PROCESS CANCELED");
                             ClearRepair();
                        }
                    ...
                    {
                         int n = JOptionPane.showConfirmDialog(null,"Price :"+dieselCar.gettPrice()+"\n Would You like  Repair ?","Repair",JOptionPane.YES_NO_OPTION);
                        if(n ==JOptionPane.YES_OPTION)
                        {
                    ...
                    {
                          int n = JOptionPane.showConfirmDialog(null,"Price :"+electricCar.gettPrice()+"\n Would You like  Repair ?","Repair",JOptionPane.YES_NO_OPTION);
                        if(n ==JOptionPane.YES_OPTION)
                        {
                ...
                if(checkWax.isSelected() == false)
                {
                    ...
                    else
                    {
                        ...
                        if(page == JOptionPane.YES_OPTION){
                            ...
                            MotherMain.waterBill += Cleaning.getConsume_WaF() * 3.26;
                            String w = "" + shorted.format(Cleaning.getConsume_WaF() * 3.26)+ " TL";
                            water.setText(w);
                ...
                if(Cleaning.DecidePriceAccordingtoCarType( (String) cbVehType.getSelectedItem(), (String) cbProfession.getSelectedItem(),cbSpecialCond.isSelected(),checkInterior.isSelected(), checkExterior.isSelected(),checkAuto.isSelected(), checkWax.isSelected() ) == 0){
                 ...
                 else
                    {
                        ...
                        if(page == JOptionPane.YES_OPTION)
                        {
                            ...
                            MotherMain.waterBill += Cleaning.getConsume_WaF() * 3.21;
                            String w = "" + shorted.format(Cleaning.getConsume_WaF() * 3.26)+ " TL";
                            water.setText(w);
    ...
    private void A1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_A1MouseClicked
      JOptionPane.showMessageDialog(rootPane, " For Boss's Car\n Choose another ");
    }//GEN-LAST:event_A1MouseClicked

    private void A21LMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_A21LMouseClicked
        JOptionPane.showMessageDialog(rootPane, "   This Area Reserved For System of Our Truck ,\n   PLEASE CHOOSE ANOTHER PARK AREA\n            Thanks for UNDERSTANDING");
    }//GEN-LAST:event_A21LMouseClicked

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        File out=new File("CikisYapanAraclar.txt");
        try{
        ...
        if (a==JOptionPane.YES_OPTION) {
            ...
            fw.write(InfoClass.parking.get(b).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
          if(Double.parseDouble(miktar.getText())>0)
          {
               if(ilk.getSelectedItem().toString().equals("TL"))
        {
            ...
            {
                double Miktar=0,Dollar,convert=0;
            ...
            {
                double Miktar=0,Euro,convert=0;
        ...
        else if(ilk.getSelectedItem().toString().equals("Dollar"))
        {
            ...
            {
                double Miktar=0,Dollar=0,convert;
        ...
        else if(ilk.getSelectedItem().toString().equals("Euro"))
        {
            ...
            else if(son.getSelectedItem().toString().equals("Dollar"))
            {
                double Miktar,Dollar,convert;
                 ...
                 if(Miktar<=MotherMain.totalEuroMoney)
                 {
                     convert=Miktar/(0.87);
                     MotherMain.totalDollarMoney+=convert;
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        ...
        try
       {
           if(Double.parseDouble(Generalquantity.getText())>0)
           {
                   int miktar;
            double payment;
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
     try
        {
            if(Double.parseDouble(gasolinequantity.getText())>0)
            {
                     int miktar;
                     double payment;
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
         ...
         try
        {
            if(Double.parseDouble(dieselquantity.getText())>0)
            {
                  int miktar;
        double payment;
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
     try
        {
            if(Double.parseDouble(electricquantitiy.getText())>0)
            {
                               int miktar;
                   double payment;
...
Aytac 300 TL
        */
         ...
         if(CleaningSalary.getSelectedItem().toString().equalsIgnoreCase("Cihat 36000 TL"))
        {
            if(MotherMain.totalMoney>36000)
            {
                MotherMain.totalMoney-=36000;
                JOptionPane.showMessageDialog(this, "Payment is Succesfull");
                 finance();
            }
            else
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
       ...
       if(MotherMain.Tax==0)
        {
          JOptionPane.showMessageDialog(this,"There is no your dept");
        }
       else
       {
            if(MotherMain.totalMoney>=MotherMain.Tax)
            {
            ...
            {
            JOptionPane.showMessageDialog(this,"unsufficient money!");
             }
       }
    ...
    private void A18mMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_A18mMouseClicked
       JOptionPane.showMessageDialog(rootPane, " For Boss's Bicycle\n Choose another ");
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        DefaultPieDataset pieDataset=new DefaultPieDataset();
        pieDataset.setValue("Male = "+Cleaning.getCleaning_Male(), Cleaning.getCleaning_Male() );
        pieDataset.setValue("Female = "+Cleaning.getCleaning_Female(), Cleaning.getCleaning_Female());                       
    ...
    private void btInventoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btInventoryActionPerformed
        ...
        dataset.setValue(Cleaning.getConsume_WaF(), "cleaning", "Water-Foam");
        dataset.setValue(Cleaning.getConsume_wax(), "cleaning", "WAX");
        dataset.setValue(Cleaning.getTotal_water_and_Foam(), "cleaning", "TOTAL Water-Foam");
        dataset.setValue(Cleaning.getTotal_wax_quantity(), "cleaning", "TOTAL Wax");        
        JFreeChart chart=ChartFactory.createBarChart3D("Material Statistics", "TOOLS", "COUNT", dataset, PlotOrientation.VERTICAL, false , true, false);
        CategoryPlot p=chart.getCategoryPlot();
        chart.setBackgroundPaint(java.awt.Color.CYAN);        
        chart.setBorderPaint(java.awt.Color.RED);
        chart.getTitle().setBackgroundPaint(java.awt.Color.white);
        p.setRangeGridlinePaint(java.awt.Color.blue);
        ChartFrame frame=new ChartFrame("Bar Chart ve Sakatlar",chart);
        frame.setVisible(true);
        frame.setSize(700,500);
    }//GEN-LAST:event_btInventoryActionPerformed

    private void ProfissionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ProfissionActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_ProfissionActionPerformed

    private void GeneralquantityMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GeneralquantityMouseEntered
        Generalquantity.setText(null);
    }//GEN-LAST:event_GeneralquantityMouseEntered

    private void GeneralquantityMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_GeneralquantityMouseExited
        
        
         if(Generalquantity.getText().equals(""))
            Generalquantity.setText("Quantitiy");
         
    }//GEN-LAST:event_GeneralquantityMouseExited

    private void gasolinequantityMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gasolinequantityMouseEntered
         gasolinequantity.setText(null);
    }//GEN-LAST:event_gasolinequantityMouseEntered

    private void gasolinequantityMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gasolinequantityMouseClicked
        gasolinequantity.setText(null);
    }//GEN-LAST:event_gasolinequantityMouseClicked

    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        if(MotherMain.totalMoney>=MotherMain.waterBill)
       {
            MotherMain.totalMoney-=MotherMain.waterBill;
            Cleaning.total_water_and_Foam += Cleaning.getConsume_WaF();
            Cleaning.setConsume_WaF(0);
            MotherMain.waterBill=0;
            JOptionPane.showMessageDialog(this,"Payment is succesfull !");
            finance();
            water.setText(0 + " TL");
       }
    ...
    private void dieselquantityMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dieselquantityMouseClicked
        dieselquantity.setText("");
    }//GEN-LAST:event_dieselquantityMouseClicked

    private void electricquantitiyMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_electricquantitiyMouseEntered
        electricquantitiy.setText("");
    }//GEN-LAST:event_electricquantitiyMouseEntered

    private void dieselquantityMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dieselquantityMouseEntered
        dieselquantity.setText("");
    }//GEN-LAST:event_dieselquantityMouseEntered

    private void miktarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_miktarMouseEntered
        miktar.setText(null);
    }//GEN-LAST:event_miktarMouseEntered
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
       ...
       {
            if(MotherMain.totalMoney>=MotherMain.Electric)
            {
                MotherMain.totalMoney-=MotherMain.Electric;
                MotherMain.Electric=0;
                JOptionPane.showMessageDialog(this,"Payment is succesfull !");
                finance();
             }
            else
    ...
    private void gasolinequantityMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_gasolinequantityMouseExited
        if(gasolinequantity.getText().equals(""))
            gasolinequantity.setText("Quantitiy");
    }//GEN-LAST:event_gasolinequantityMouseExited

    private void dieselquantityMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dieselquantityMouseExited
         if(dieselquantity.getText().equals(""))
            dieselquantity.setText("Quantitiy");
    }//GEN-LAST:event_dieselquantityMouseExited

    private void electricquantitiyMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_electricquantitiyMouseExited
        if(electricquantitiy.getText().equals(""))
            electricquantitiy.setText("Quantitiy");
    }//GEN-LAST:event_electricquantitiyMouseExited

    private void miktarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_miktarMouseExited
        if(miktar.getText().equals(""))
            miktar.setText("Quantitiy");
    }//GEN-LAST:event_miktarMouseExited

    private void btDataRepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDataRepActionPerformed
        REPAIR_CLEANING_PARK repFrame = new REPAIR_CLEANING_PARK();
        repFrame.setVisible(true);
        AddtoTableParking();
        AddtoWash();
        AddtoReapiring();
    }//GEN-LAST:event_btDataRepActionPerformed
