...
public class Cleaning  extends MotherMain {
    ...
    public static int  total_water_and_Foam= 200;
    public static int total_wax_quantity = 250;
    ...
    public static int getCleaning_Male() {
        return Cleaning_Male;
    }

    public static int getCleaning_Female() {
        return Cleaning_Female;
    }
    ...
    public static double DecidePriceAccordingtoCarType(String car, String profession , boolean condition, boolean interior_wash , boolean exterior_wash, boolean auto_Hairdresser, boolean wax_polish)
    {
        ...
        if (car.equalsIgnoreCase("lorry"))
        {
            ...
            else if(( profession.equalsIgnoreCase("Police") || profession.equalsIgnoreCase("Student") || profession.equalsIgnoreCase("Soldier") ) && condition == false)
                sales -= (sales * 0.08);
    ...
    public static void setConsume_wax(int consume_wax) {
        Cleaning.consume_wax = consume_wax;
    }

    public static void setConsume_WaF(int consume_WaF) {
        Cleaning.consume_WaF = consume_WaF;
    }
